function test_secondorderrungekutta
...
%
[tk1,xk1]=secondordererungekutta(0,5,1,f,.5,10^1);
[tk2,xk2]=secondordererungekutta(0,5,1,f,.5,10^2);
[tk3,xk3]=secondordererungekutta(0,5,1,f,.5,10^3);
[tk4,xk4]=secondordererungekutta(0,5,1,f,.5,10^4);
[tktrue,xktrue]=secondordererungekutta(0,5,1,f,.5,10^5);
%
